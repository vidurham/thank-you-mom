...
var picture = function() {
    ...
    if (date === "May 10th, 2022") {
        var img1 = document.createElement("img");
        img1.src = "./images/pic78.JPG";
        familyPicEl.append(img1);
        var quote1 = document.createElement("p");
        quote1.innerHTML = "'Thank you for all the days you chaperoned a trip or worked at the school, it was always pretty cool to have the “cool mom” at school.' -Kelly";
        thanksEl.append(quote1);
    }
    if (date === "May 11th, 2022") {
        var img1 = document.createElement("img");
        img1.src = "./images/pic149.JPG";
        familyPicEl.append(img1);
        var quote1 = document.createElement("p");
        quote1.innerHTML = "'Thanks for always helping with school projects! Still not artistic or creative at all but I survived!' -Nicholas";
        thanksEl.append(quote1);
    }
    if (date === "May 12th, 2022") {
        var img1 = document.createElement("img");
        img1.src = "./images/pic50.JPG";
        familyPicEl.append(img1);
        var quote1 = document.createElement("p");
        quote1.innerHTML = "'Thanks for making everything better, just by being there.' -Dad";
        thanksEl.append(quote1);
    }
    if (date === "May 13th, 2022") {
        var img1 = document.createElement("img");
        img1.src = "./images/pic101.JPG";
        familyPicEl.append(img1);
        var quote1 = document.createElement("p");
        quote1.innerHTML = "'Thanks for singing You Are My Sunshine, Twinkle Twinkle Little Star, and I'll Love You Forever every night before bed when we were little' -Vincent";
        thanksEl.append(quote1);
    }
    if (date === "May 14th, 2022") {
        var img1 = document.createElement("img");
        img1.src = "./images/pic21.JPG";
        familyPicEl.append(img1);
        var quote1 = document.createElement("p");
        quote1.innerHTML = "'Thank you for driving me to all the away games when I was hurt for this season. It would have killed me to miss those games' -Joseph";
        thanksEl.append(quote1);
    }
    if (date === "May 15th, 2022") {
        var img1 = document.createElement("img");
        img1.src = "./images/pic164.JPG";
        familyPicEl.append(img1);
        var quote1 = document.createElement("p");
        quote1.innerHTML = "'Thank you for curling my hair when we Irish danced' -Jess";
        thanksEl.append(quote1);
    }
    if (date === "May 16th, 2022") {
        var img1 = document.createElement("img");
        img1.src = "./images/pic205.JPG";
        familyPicEl.append(img1);
        var quote1 = document.createElement("p");
        quote1.innerHTML = "'Thank you for getting your nails done with me! I love spending that time together.' -Kelly";
        thanksEl.append(quote1);
    }
    if (date === "May 17th, 2022") {
        var img1 = document.createElement("img");
        img1.src = "./images/pic171.JPG";
        familyPicEl.append(img1);
        var quote1 = document.createElement("p");
        quote1.innerHTML = "'Thanks for always being our number one fan.' -Dad";
        thanksEl.append(quote1);
    }
    if (date === "May 18th, 2022") {
        var img1 = document.createElement("img");
        img1.src = "./images/pic96.JPG";
        familyPicEl.append(img1);
        var quote1 = document.createElement("p");
        quote1.innerHTML = "'Thanks for helping me decide to take the coding class, best decision I've made in a long time' -Vincent";
        thanksEl.append(quote1);
    }
    if (date === "May 19th, 2022") {
        var img1 = document.createElement("img");
        img1.src = "./images/pic75.JPG";
        familyPicEl.append(img1);
        var quote1 = document.createElement("p");
        quote1.innerHTML = "'Thank you for allowing us and encouraging us to get out and see the world.' -Kelly";
        thanksEl.append(quote1);
    }
    if (date === "May 20th, 2022") {
        var img1 = document.createElement("img");
        img1.src = "./images/pic95.JPG";
        familyPicEl.append(img1);
        var quote1 = document.createElement("p");
        quote1.innerHTML = "'Thank you for mini muffins every Friday. Those slap.' -Nicholas";
        thanksEl.append(quote1);
    }
    if (date === "May 21st, 2022") {
        var img1 = document.createElement("img");
        img1.src = "./images/pic274.JPG";
        familyPicEl.append(img1);
        var quote1 = document.createElement("p");
        quote1.innerHTML = "'Thank you for coming down to my graduation, it means the world to me, excited to see you, Dad, and Joe!' -Vincent";
        thanksEl.append(quote1);
    }
    if (date === "May 22nd, 2022") {
        var img1 = document.createElement("img");
        img1.src = "./images/pic216.JPG";
        familyPicEl.append(img1);
        var quote1 = document.createElement("p");
        quote1.innerHTML = "'Thank you for reminding Nick to not drink too much water before he goes to sleep' -Joseph";
        thanksEl.append(quote1);
    }
    if (date === "May 23rd, 2022") {
        var img1 = document.createElement("img");
        img1.src = "./images/pic154.JPG";
        familyPicEl.append(img1);
        var quote1 = document.createElement("p");
        quote1.innerHTML = "'Thank you for all the McDonald's trips back in the day. Nothing like some cat-food(parfait) and cinnamon rolls to start the day' -Vincent";
        thanksEl.append(quote1);
    }
    if (date === "May 24th, 2022") {
        var img1 = document.createElement("img");
        img1.src = "./images/pic102.JPG";
        familyPicEl.append(img1);
        var quote1 = document.createElement("p");
        quote1.innerHTML = "'Thanks for having the fashion sense to help those of us who don't.' -Dad";
        thanksEl.append(quote1);
    }
    if (date === "May 25th, 2022") {
        var img1 = document.createElement("img");
        img1.src = "./images/pic163.JPG";
        familyPicEl.append(img1);
        var quote1 = document.createElement("p");
        quote1.innerHTML = "'Thank you for the cheesy potato recipe!' -Jess";
        thanksEl.append(quote1);
    }
    ...
    if (date === "May 31st, 2022") {
        var img1 = document.createElement("img");
        img1.src = "./images/pic81.JPG";
        familyPicEl.append(img1);
        var quote1 = document.createElement("p");
        quote1.innerHTML = "'Thanks for helping me pick out a new laptop and get ready for everything after Lucid! Love you lots' -Vincent";
        thanksEl.append(quote1);
    }
    if (date === "June 1st, 2022") {
        var img1 = document.createElement("img");
        img1.src = "./images/pic245.JPG";
        familyPicEl.append(img1);
        var quote1 = document.createElement("p");
        quote1.innerHTML = "'Thank you for believing in me even when I may not believe in myself.' -Kelly";
        thanksEl.append(quote1);
    }
    if (date === "June 2nd, 2022") {
        var img1 = document.createElement("img");
        img1.src = "./images/pic123.JPG";
        familyPicEl.append(img1);
        var quote1 = document.createElement("p");
        quote1.innerHTML = "'Thanks for always wanting to have as much fun as possible.' -Dad";
        thanksEl.append(quote1);
    }
    if (date === "June 3rd, 2022") {
        var img1 = document.createElement("img");
        img1.src = "./images/pic63.JPG";
        familyPicEl.append(img1);
        var quote1 = document.createElement("p");
        quote1.innerHTML = "'Thanks for helping me with all of my move ins and move outs!!' -Nick";
        thanksEl.append(quote1);
    }
    if (date === "June 4th, 2022") {
        var img1 = document.createElement("img");
        img1.src = "./images/pic182.JPG";
        familyPicEl.append(img1);
        var quote1 = document.createElement("p");
        quote1.innerHTML = "'Thank you for coming to all of my track meets. The best one was still when Beth fell over the hurdles' -Jess";
        thanksEl.append(quote1);
    }
    if (date === "June 5th, 2022") {
        var img1 = document.createElement("img");
        img1.src = "./images/pic34.JPG";
        familyPicEl.append(img1);
        var quote1 = document.createElement("p");
        quote1.innerHTML = "'Thank you for being my book partner - there’s nothing better than going to Barnes and Noble to pick out new books, but the best is being able to discuss them with you!' -Kelly";
        thanksEl.append(quote1);
    }
    if (date === "June 6th, 2022") {
        var img1 = document.createElement("img");
        img1.src = "./images/pic225.JPG";
        familyPicEl.append(img1);
        var quote1 = document.createElement("p");
    ...
    if (date === "June 7th, 2022") {
        var img1 = document.createElement("img");
        img1.src = "./images/pic104.JPG";
        familyPicEl.append(img1);
        var quote1 = document.createElement("p");
        quote1.innerHTML = "'Thanks for always having positive input when issues arise.' -Dad";
        thanksEl.append(quote1);
    }
    if (date === "June 8th, 2022") {
        var img1 = document.createElement("img");
        img1.src = "./images/pic159.JPG";
        familyPicEl.append(img1);
        var quote1 = document.createElement("p");
        quote1.innerHTML = "'Thank you for telling me when I am overreacting' -Jess";
        thanksEl.append(quote1);
    }
    if (date === "June 9th, 2022") {
        var img1 = document.createElement("img");
        img1.src = "./images/pic232.JPG";
        familyPicEl.append(img1);
        var quote1 = document.createElement("p");
        quote1.innerHTML = "'Thank you for not letting me change my major to business....Jesus that would’ve been a waste' -Joseph";
        thanksEl.append(quote1);
    }
    if (date === "June 10th, 2022") {
        var img1 = document.createElement("img");
        img1.src = "./images/pic251.JPG";
        familyPicEl.append(img1);
        var quote1 = document.createElement("p");
        quote1.innerHTML = "'Thanks for all the rides to and from Fenwick, sometimes the best part was the journey up and back' -Vincent";
        thanksEl.append(quote1);
    }
    if (date === "June 11th, 2022") {
        var img1 = document.createElement("img");
        img1.src = "./images/pic186.JPG";
        familyPicEl.append(img1);
        var quote1 = document.createElement("p");
        quote1.innerHTML = "'Thanks for the best siblings and family in the world' -Nick";
        thanksEl.append(quote1);
    }
    if (date === "June 12th, 2022") {
        var img1 = document.createElement("img");
        img1.src = "./images/pic222.JPG";
        familyPicEl.append(img1);
        var quote1 = document.createElement("p");
        quote1.innerHTML = "'Thank you for placing a priority on education and making sure we were all able to go where we wanted to and supporting us while there - not many people are that lucky.' -Kelly";
        thanksEl.append(quote1);
    }
    if (date === "June 13th, 2022") {
        var img1 = document.createElement("img");
        img1.src = "./images/pic107.JPG";
        familyPicEl.append(img1);
        var quote1 = document.createElement("p");
        quote1.innerHTML = "'' -Dad";
        thanksEl.append(quote1);
    }
    ...
    if (date === "June 21st, 2022") {
        var img1 = document.createElement("img");
        img1.src = "./images/pic146.JPG";
        familyPicEl.append(img1);
        var quote1 = document.createElement("p");
        quote1.innerHTML = "'Thank you for loving all of us, even on our worst days' -Joseph";
        thanksEl.append(quote1);
    }
    if (date === "June 22nd, 2022") {
        ...
        familyPicEl.append(img1);
        var quote1 = document.createElement("p");
        quote1.innerHTML = "'Thank you for sharing your closet with me when I need something at home' -Kelly";
        thanksEl.append(quote1);
    }
    ...
    if (date === "June 24th, 2022") {
        var img1 = document.createElement("img");
        img1.src = "./images/pic227.JPG";
        familyPicEl.append(img1);
        var quote1 = document.createElement("p");
        quote1.innerHTML = "'Thanks for all the great memories and the ones to come' -Dad";
        thanksEl.append(quote1);
    }
    ...
    if (date === "June 29th, 2022") {
        var img1 = document.createElement("img");
        img1.src = "./images/pic230.JPG";
        familyPicEl.append(img1);
        var quote1 = document.createElement("p");
        quote1.innerHTML = "'Thank you for all the toys and games you gave us growing up! My many barbies, Polly pockets, dress ups and more - you always made sure we were happy.' -Kelly";
        thanksEl.append(quote1);
    }
    if (date === "June 30th, 2022") {
        var img1 = document.createElement("img");
        img1.src = "./images/pic105.JPG";
        familyPicEl.append(img1);
        var quote1 = document.createElement("p");
        quote1.innerHTML = "'Thanks for taking care of the house, including building this one.' -Dad";
        thanksEl.append(quote1);
    }
